...
*/
<template>
  <div class="waste-transaction-detail">
          ...
          <template slot-scope="props">
            <el-row id="content">
              ...
              <el-col :span="4" class="enterprise">
                <span>{{ props.row.dangerousEnterpriseName }}</span>
              </el-col>
              ...
              <el-col :span="2" class="operation">
                <span>{{props.row.payDirection=='Add'?"收入":props.row.payDirection=='Less'?"支出":""}}</span>
              </el-col>
            </el-row>
...
<script>
  ...
  export default {
    name: "wasteTransactionDetail",//订单管理
    data() {
      return {
    ...
    methods: {
      ...
      handleSelect(key, keyPath) {
        this.$router.push({
          path: 'wasteTransactionDetail',//交易明细
          query: {
