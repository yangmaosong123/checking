          ...
          <template slot-scope="props">
            <el-row id="content">
                ...
                <el-row class="title">
                  <el-col>
                    <el-tooltip placement="right-start"
                      ...
                      <el-button @click="handleGoToWasteDetail(props.row)" class="nowrap nowrap-h3"
                                 type="text">
                        {{props.row.daName}}
                      </el-button>
                    </el-tooltip>
              ...
              <el-col :span="3" class="details">
                <span>
                  {{props.row.status=='Y'?'已签约':props.row.status=='N'?'未签约':''}}
                </span>
              </el-col>
              <el-col :span="4" class="operation">
                <a v-show="props.row.status=='Y'"
                   :href="$store.state.fileDownloadUrls+props.row.id+'&bizObjName=CZQS'">
                  查看合同
                </a>
              </el-col>
            </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      handleGetTableData() {
        ...
        _this.$axios({
          method: "post",
          url: "/quote/selectOrderQuoteContract",
          data: {
