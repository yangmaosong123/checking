...
new Vue({
  ...
  store,
  created() {
    this.loadDictionary("REC_LOGISTICS_COMPANY,def_img_type,ORDER_STATUS,ORDER_STATUS_QUOTE,bjzt,qdzt,cxsj,unit,zycp,hslb,sshy,hyly,sszl,sscp,zycp,sshy,hszl,ddzt,hsly,hyly,hyzl,hylb,hszl,hslb,gsxz,qylx,rec_order_status_for_buyer,order_status_for_seller");
